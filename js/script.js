...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // ----------------------------------------------------------
  // BANNER IMPACT PROMO - 300x250 in sidebar (dupa primul widget)
  // ----------------------------------------------------------
  ...
  document.querySelectorAll('.sidebar').forEach(function(sb) {
    var firstWidget = sb.querySelector('.sidebar-widget');
    if (firstWidget) {
      firstWidget.insertAdjacentHTML('afterend', impactSidebarHTML);
    } else {
      sb.insertAdjacentHTML('afterbegin', impactSidebarHTML);
    }
  });
